...
- 由于流水线时间等问题，快照版发布流水线在[gitcode](https://gitcode.net/xuxiaowei-com-cn/spring-boot-starter-redis)
  ，正式版发布流水线在[gitlab](https://gitlab.com/xuxiaowei-com-cn/spring-boot-starter-redis)
